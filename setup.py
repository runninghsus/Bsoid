...
setup(
  ...
  version='0.1.3.2',      # Start with a small number and increase it with every change you make
  ...
  download_url='https://github.com/runninghsus/Bsoid/archive/v0.1.3.2.tar.gz',    # I explain this later on
